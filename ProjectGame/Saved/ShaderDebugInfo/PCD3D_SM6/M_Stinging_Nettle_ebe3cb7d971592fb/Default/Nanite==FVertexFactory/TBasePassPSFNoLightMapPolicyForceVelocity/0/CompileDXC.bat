...
%DXC% -HV 2021 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T ps_6_6 -E MainPS -Fc BasePassPixelShader.d3dasm -Fo BasePassPixelShader.dxil BasePassPixelShader.usf
:END
PAUSE
